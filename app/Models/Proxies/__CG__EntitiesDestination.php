 ...
 */
class Destination extends \Entities\Destination implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Destination' . "\0" . 'id_destination', '' . "\0" . 'Entities\\Destination' . "\0" . 'name', '' . "\0" . 'Entities\\Destination' . "\0" . 'rating', '' . "\0" . 'Entities\\Destination' . "\0" . 'favorite', '' . "\0" . 'Entities\\Destination' . "\0" . 'description', '' . "\0" . 'Entities\\Destination' . "\0" . 'image_url', '' . "\0" . 'Entities\\Destination' . "\0" . 'created_at', '' . "\0" . 'Entities\\Destination' . "\0" . 'updated_at'];
        }
    ...
    public function getIdDestination()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdDestination', []);

        return parent::getIdDestination();
    }
    ...
    public function setFavorite($favorite)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFavorite', [$favorite]);
