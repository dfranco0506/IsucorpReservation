 ...
 */
class ContactType extends \Entities\ContactType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\ContactType' . "\0" . 'id_contact_type', '' . "\0" . 'Entities\\ContactType' . "\0" . 'name', '' . "\0" . 'Entities\\ContactType' . "\0" . 'created_at', '' . "\0" . 'Entities\\ContactType' . "\0" . 'updated_at', '' . "\0" . 'Entities\\ContactType' . "\0" . 'contacts'];
        }
    ...
    public function getIdContactType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdContactType', []);

        return parent::getIdContactType();
    }
