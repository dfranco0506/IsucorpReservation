...
<?= $this->section("content") ?>
	<section id="banner">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-sm-4 col-md-4"><label><b><?php echo lang('App.list_reservations');?></b></label></div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-3 col-sm-4 col-md-4 fontuser">
				<select class="sort" id="user_type" name="sort_by" placeholder="Contact Type" required>
                ...
                "columns": [
                    ...
                    {"data": "addfavorites"},
                    {
                        "data": "favorite", render: function (data) {
                            if (data === 0) {
                                return '<img class="td-internal-image" src="/img/favorite-heart-icon-disabled.png" height="20" width="20"/><br />';
                            } else {
                                return '<img class="td-internal-image" src="/img/favorite-heart-icon-active.png" height="20" width="20"/><br />';
                            }
