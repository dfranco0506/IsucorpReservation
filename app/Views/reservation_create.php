...
<?= $this->section("content") ?>
	...
	<section id="banner">
		<div class="container">
			<div class="row" >
				<div class="col-lg-3 col-sm-4 col-md-4"><label><b><?php echo lang('App.create_reservation');?></b></label></div>
		...
		<form method="post" action="<?= base_url() ?>/reservation/store">
			<div class="row" style="background-color: white;margin-bottom: 10px">
				<div class="col-lg-3 col-sm-4 col-md-4 fontuser">
					<label>
						<input type="text" placeholder="<?php echo lang('Validation.contact_name');?>" name="contact_name" required>
					</label>
				...
				<div class="col-lg-3 col-sm-4 col-md-4 fontuser">
					<label>
						<input type="text" placeholder="<?php echo lang('Validation.contact_phone');?>" name="contact_phone" required>
					</label>
					<i class="fa fa-phone fa-2x"></i>
				</div>
				<div class="col-lg-3 col-sm-4 col-md-4 fontuser">
					<label>
						<input type="text" id="contact_birthday" placeholder="<?php echo lang('Validation.contact_birthday');?>" name="contact_birthday" required data-date-format="dd/mm/yyyy">
					</label>
			...
			<div class="row" style="background-color: white;margin-bottom: 10px">
				...
				<div class="col-lg-3 col-sm-4 col-md-4 fontuser">
					<label>
						<input type="text" id="reservation_date" placeholder="<?php echo lang('Validation.reservation_date');?>" name="reservation_date" required data-date-format="dd/mm/yyyy">
					</label>
					<i class="fa fa-calendar fa-2x"></i>
				</div>
				<div class="col-lg-3 col-sm-4 col-md-4 fontuser">
					<label>
						<input class="timepicker" type="text" placeholder="<?php echo lang('Validation.reservation_time');?>" name="reservation_time" id="reservation_time" required>
					</label>
					<i class="fa fa-calendar fa-2x"></i>
				</div>
			</div>
